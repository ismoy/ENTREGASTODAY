...
import cl.tofcompany.entregastoday.Provider.CobroAutomovilProvider;
...
import cl.tofcompany.entregastoday.modelos.CobroAutomovil;
...
public class DetallesCotizacionServicioAuto extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private CobroAutomovilProvider McobroAutomovilProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalles_cotizacion_servicio_auto);
        ...
        McobroAutomovilProvider = new CobroAutomovilProvider();
    ...
    class MyAsyncClasss extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            ...
            super.onPreExecute();
            pDialog =  ProgressDialog.show(DetallesCotizacionServicioAuto.this
        ...
        protected Void doInBackground(Void... mApi) {
            try {
                ...
                sender.sendMail(subject, "Tienes una nueva solicitud " +"\n"+
                        ...
                        " Email: " + correocliente+"\n"+
                        " Desde: " + mExtraOrigin+"\n"+
                        " Hasta: " + mExtraDestination+"\n"+
                        " Distancia: " + distancias+"\n"+
                        " Duration: " + duracion+"\n"+
                        " Costo: " + precio + " CLP "+"\n"+
                        " Tipo Servicio: " + " SERVICIO DE AUTOMOVIL "+"\n"+
        ...
        protected void onPostExecute(Void result) {
            ...
            pDialog.cancel();
           /* AlertDialog.Builder builder = new AlertDialog.Builder(DetallesCotizacionServicioAuto.this);
            ...
            builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    Intent intent = new Intent(DetallesCotizacionServicioAuto.this, ServicioEnvio.class);
                    startActivity(intent);
                }
            });
            builder.show();*/
            new SweetAlertDialog(DetallesCotizacionServicioAuto.this, SweetAlertDialog.SUCCESS_TYPE)
    ...
    private void calculatePrice(double distancevalue) {
        McobroAutomovilProvider.getCobroAutomovil().addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    CobroAutomovil cobroAutomovil = snapshot.getValue(CobroAutomovil.class);
                    assert cobroAutomovil != null;
                    double totalDistance = Math.round(distancevalue * cobroAutomovil.getKm());
