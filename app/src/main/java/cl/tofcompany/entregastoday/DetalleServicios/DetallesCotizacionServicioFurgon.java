...
import cl.tofcompany.entregastoday.Provider.CobroFurgonProvider;
...
import cl.tofcompany.entregastoday.modelos.CobroFurgon;
...
public class DetallesCotizacionServicioFurgon extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private Button mbtncotizarfurgon;
    private HistoryBooking mHistoryBooking;
    private HistoryBookingProvider mHistoryBookingProvider;
    private CobroFurgonProvider mCobroFurgonProvider;
    ...
    private String servicio = " SERVICIO DE FURGON ";


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_detalles_cotizacion_servicio_furgon);
        ...
        mCobroFurgonProvider = new CobroFurgonProvider();
        mbtncotizarfurgon = findViewById(R.id.btncotizarfurgon);
        sender = new GmailSender.GMailSender(user,password);
        mbtncotizarfurgon.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    class MyAsyncClass extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog =  ProgressDialog.show(DetallesCotizacionServicioFurgon.this
        ...
        protected void onPostExecute(Void result) {
            ...
            progressDialog.cancel();
             /* AlertDialog.Builder builder = new AlertDialog.Builder(DetallesCotizacionServicioFurgon.this);
              ...
              builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                  ...
                  public void onClick(DialogInterface dialog, int which) {
                      Intent intent = new Intent(DetallesCotizacionServicioFurgon.this, ServicioEnvio.class);
                      startActivity(intent);
                  }
              });
             builder.show();*/
            new SweetAlertDialog(DetallesCotizacionServicioFurgon.this, SweetAlertDialog.SUCCESS_TYPE)
    ...
    private void calculatePrice(double distancevalue) {
        mCobroFurgonProvider.getCobroFurgon().addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()){
                    CobroFurgon cobroFurgon = snapshot.getValue(CobroFurgon.class);
                    assert cobroFurgon != null;
                    double totalDistance = Math.round(distancevalue * cobroFurgon.getKm());
