...
import cl.tofcompany.entregastoday.Provider.CobroMotocicletaProvider;
...
import cl.tofcompany.entregastoday.modelos.CobroMotociclista;
...
public class DetallesCotizacionServicioMoto extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private CobroMotocicletaProvider mcobroMotocicletaProvider;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detalles_cotizacion_servicio_moto);
        ...
        mcobroMotocicletaProvider = new CobroMotocicletaProvider();
       ...
       class MyAsyncClassm extends AsyncTask<Void, Void, Void> {
           ...
           protected void onPreExecute() {
               ...
               super.onPreExecute();
               pDialog =  ProgressDialog.show(DetallesCotizacionServicioMoto.this
           ...
           protected Void doInBackground(Void... mApi) {
               try {
                   ...
                   sender.sendMail(subject, "Tienes una nueva solicitud " +"\n"+
                           ...
                           " Duration: " + duracion+"\n"+
                           " Costo: " + precio + " CLP "+"\n"+
                           " Tipo Servicio: " + " SERVICIO DE MOTOCICLISTA "+"\n"+
           ...
           protected void onPostExecute(Void result) {
               ...
               pDialog.cancel();
              /* AlertDialog.Builder builder = new AlertDialog.Builder(DetallesCotizacionServicioMoto.this);
               ...
               builder.setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                   ...
                   public void onClick(DialogInterface dialog, int which) {
                       Intent intent = new Intent(DetallesCotizacionServicioMoto.this, ServicioEnvio.class);
                       startActivity(intent);
                   }
               });
               builder.show();*/
               new SweetAlertDialog(DetallesCotizacionServicioMoto.this, SweetAlertDialog.SUCCESS_TYPE)
                       .setTitleText(String.valueOf(Html.fromHtml("<font color='#509324'>Envío confirmado</font>")))
                       .setContentText(String.valueOf(Html.fromHtml( "<font align-item='justify'</font> Uno de nuestros agentes se comunicará contigo para coordinar la entrega y los medios de pago.\n" +
    ...
    private void calculatePrice(double distancevalue) {
      mcobroMotocicletaProvider.getCobroMotociclista().addListenerForSingleValueEvent(new ValueEventListener() {
          @Override
          public void onDataChange(@NonNull DataSnapshot snapshot) {
              if (snapshot.exists()){
                  CobroMotociclista cobroMotociclista = snapshot.getValue(CobroMotociclista.class);
                  double totalDistance = Math.round(distancevalue * cobroMotociclista.getKm());
